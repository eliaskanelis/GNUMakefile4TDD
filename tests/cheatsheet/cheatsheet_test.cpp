...
TEST_GROUP( cheetsheet )
{
	...
	{
		/*
		 * Use this section to initialise before each test execution.
		 */
	}
	...
	{
		/*
		 * Use this section to cleanup after each test execution.
		 */
	}
};
/* clang-format on */
...
TEST(cheetsheet, Float)
{
	...
	DOUBLES_EQUAL_TEXT(1.000,
	                   1.001,
	                   0.01,
	                   "Floats are not withing tolerances");
}
...
TEST(cheetsheet, FunctionPointers)
{
	...
	FUNCTIONPOINTERS_EQUAL_TEXT((void (*)())0xa5a5,
	                            (void (*)())0xa5a5,
